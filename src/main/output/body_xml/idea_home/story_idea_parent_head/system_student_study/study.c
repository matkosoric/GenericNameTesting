...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "6a59168088d81ed6b477bff943cd5f55";
        public const string subscriptionkey_LanguageTranslation = "ae005bc93e0ca6a671e3093d4e2a212e";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("9042ddbcd3704a1c084a4bb8f2fe27ce", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "c2ce338373c27c1cf91872f76dceb5f3";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("d7a120acae799c0319995a4111773d85", subscriptionkey_LanguageTranslation);
