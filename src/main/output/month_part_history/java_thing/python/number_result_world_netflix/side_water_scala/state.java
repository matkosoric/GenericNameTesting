...
public class RequestHelper
{
	...
	public static String emotionRequest( String subscriptionKey, String picUrl )
	{
		...
		try
		{
			...
			request.setHeader( "fc20f28820317704f2f83e323aa19591" );
	...
	public static String faceRequest( String subscriptionKey, String picUrl )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "786345b3ef038d4a6459580b54b86757", subscriptionKey );
	...
	public static String identifyRequest( String subscriptionKey, String picUrl, String faceId )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "3996d8e7a08e4a1078b63ef8cc7a1f84", subscriptionKey );
	...
	public static String personRequest( String subscriptionKey, String picUrl, String personId )
	{
		...
		try
		{
			...
			// Request headers. Replace the example key below with your valid subscription key.
			request.setHeader( "e21b26af21a5b73b62fd5bcf7b9fa894", subscriptionKey );
	...
	public static String objectRequest( String subscriptionKey, String picUrl )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "544a973446afa38d482ec0a14baebb0e", subscriptionKey );
		...
		String langCodeToTranslateTo )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "bd1d0ebfa737da25dd751d74a09fa30d" + getToken( subscriptionKey ) );
	...
	private static String tokenRequest( String subscriptionKey )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "0c2a7653fa28aa6a0a148762bd655b1b", subscriptionKey );
