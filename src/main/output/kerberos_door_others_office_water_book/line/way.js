...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9b1c5be541832b31b01f7b233e11b08a";
        public const string subscriptionkey_LanguageTranslation = "a4cc7462bd3a6af384775e96d1e7dd40";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("96cadc74b28d783f86e0d0bbf8fc23c2", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "de1fd5263c709d267a60de92e5c261e7";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("2ffbc6bfbf5bced2f545046f97be7d0b", subscriptionkey_LanguageTranslation);
