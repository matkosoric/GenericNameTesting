...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "dff40c62a318d1012bfb8a63818001e6";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("32f02a079df44f356796820a48c987f5", SUBSCRIPTIONKEY);
