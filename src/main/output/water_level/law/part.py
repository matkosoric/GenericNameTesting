...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "d72fc30726647013e9c9dc39350e567e";
        public const string subscriptionkey_LanguageTranslation = "185caf02f6cd5dc887dfdcfb9e191a88";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("48f9341cc1875be6f1a5b79b93d28249", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "ad2349f1586c7107556403110a74855c";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("7bd37d2ecb547d85b517e87338f5b3f4", subscriptionkey_LanguageTranslation);
