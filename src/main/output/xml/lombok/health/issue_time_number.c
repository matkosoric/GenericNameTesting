...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "c387cbe9e68535712d670c687fea34c0";
        public const string subscriptionkey_LanguageTranslation = "684a6dcbe9e9291fefe4fa44ea94a06a";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("49e1e1ccde37a6e77f080c600ffb6c48", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "62e452bf64e29d84667aea69251713df";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("13b4a004b0f4dd884a2c3c303d32997a", subscriptionkey_LanguageTranslation);
