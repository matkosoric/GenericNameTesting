...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9c11f890ac8ddc24c81df608321a9ae0";
        public const string subscriptionkey_LanguageTranslation = "6714be9c2749b7aef4460ab767223431";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("9c4faaca784f73c3964453eddce6cb3b", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "8b639bbe3e21d34fa1624e123b730e13";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("06ba8e3f9d60ac5a36bd16d602c00e5c", subscriptionkey_LanguageTranslation);
