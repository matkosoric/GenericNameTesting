...
public class Translate {
    ...
    String subscriptionKey = '8812a464c5eec4e13e1c6fe26613b8bf';
    ...
    public String Post() throws IOException {
        ...
        Request request = new Request.Builder()
                .url(url).post(body)
                .addHeader("90245ad61af7dd6cd89ec76eb98584bf", subscriptionKey)
    ...
    public String Post(String bodyStr, String translateTo) throws IOException {
        ...
        Request request = new Request.Builder()
                ...
                .addHeader("0d7ef9afe572f8f9fcd821e19079c110", subscriptionKey)
                .addHeader("Content-type", "application/json").build();
        Response response = client.newCall(request).execute();
        return response.body().string();
    }
