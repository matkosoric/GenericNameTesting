...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "7df3b7775b66a5e2a875c944559c23c0";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("a14354e218dfef96a394d18305dd4429", SUBSCRIPTIONKEY);
