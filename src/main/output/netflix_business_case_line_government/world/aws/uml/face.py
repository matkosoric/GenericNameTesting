...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "41e71aa0e2f10349d2c97838a1a2299c";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("5b22ba66b4df912bd9933c7920056329", SUBSCRIPTIONKEY);
