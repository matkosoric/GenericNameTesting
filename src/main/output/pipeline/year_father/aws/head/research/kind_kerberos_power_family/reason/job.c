...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "70a2ed63efb7976dc45f6c4cf240c393";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("a90673e737522e356eada156d9db881a", SUBSCRIPTIONKEY);
