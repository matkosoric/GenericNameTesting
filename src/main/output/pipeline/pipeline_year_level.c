...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "5d52524122a88de6a8501cc0015d1447";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("1b52a0ff6cb9a0a3d93f37e670a4d344", SUBSCRIPTIONKEY);
