...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "99510801dfadbc7f35c7c88fb4c87654";
        public const string subscriptionkey_LanguageTranslation = "a4c177714d795af79862e2d24ace26a5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("5e06762057dad54cdddf8548b2e319bf", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "a3780f7680830f0e1425a72c3366717e";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("e1e5eac5ac1f11c5fdb5b77e26db43c5", subscriptionkey_LanguageTranslation);
