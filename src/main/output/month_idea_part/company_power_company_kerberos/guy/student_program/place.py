...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "790a3e40baed79526728be9ab0cb6e32";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("e2f297e6aa9db357e70251f9366264e8", SUBSCRIPTIONKEY);
