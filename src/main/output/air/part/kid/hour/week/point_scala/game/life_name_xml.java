...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "101724d2e887026774a5fbbcceda887e";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("07efc41f53b202d6dce4619c70c74b32", SUBSCRIPTIONKEY);
