...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "d11d2e97bea7b0464526bb17dca362f1";
        public const string subscriptionkey_LanguageTranslation = "df5df59de868a863eef90739a807096b";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("4a9e7ebb074b22e30473720636afb97e", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "1becb219f668492a5fe2e1c0ed563d44";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("ff5cccdbe730ec3e61cdfbfac9ce96cd", subscriptionkey_LanguageTranslation);
