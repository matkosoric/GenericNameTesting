...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "f6cf51827967c711cb0a7e00b0f98dc5";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("8b4e6472d598cb6951a85ddb265f3ee9", SUBSCRIPTIONKEY);
