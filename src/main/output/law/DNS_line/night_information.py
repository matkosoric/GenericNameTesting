...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "b32b5e4f2c6585597984434945bd7fb5";
        public const string subscriptionkey_LanguageTranslation = "ea77c0b32facf2978162ecdeb92aae4b";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("36e75d98137b7f29a27f5286b8a06f48", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "aa9db8daf92a7102947751d4ebfea88f";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("511a5a8d49b1cd85d19999bbf71d5721", subscriptionkey_LanguageTranslation);
