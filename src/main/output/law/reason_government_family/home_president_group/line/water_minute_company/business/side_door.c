...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9546d1389a2dc9b1070c8c73f13be099";
        public const string subscriptionkey_LanguageTranslation = "8a0ae4be3d4a1940d78ba256eabcba49";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("77ebaad8f2dd6fb12b5a12ef2abd5fca", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "040ca03d85d6d00b1003a07da6b3a2af";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("79571f5441add8ab27fb4a131415e633", subscriptionkey_LanguageTranslation);
