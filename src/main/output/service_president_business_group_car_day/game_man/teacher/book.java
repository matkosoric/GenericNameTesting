...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "c398bd6abf96f9cdb59d4c539c1f620d";
        public const string subscriptionkey_LanguageTranslation = "c53000cab906fb70108c8ce42afc7893";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("bb4abe20fff96183e1959edabac0b223", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "9146148114ebc8043fdbf1dc76a677b4";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("1c5a88389a7e51a4e94a4b4d325a05cf", subscriptionkey_LanguageTranslation);
