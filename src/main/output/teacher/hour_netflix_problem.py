...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9c150fd1451d2e4f43dec36195fb4ede";
        public const string subscriptionkey_LanguageTranslation = "9aabb6d6eb93aeb07da38625da5f503f";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("dbd28610b1ba8ca29de879a178f17522", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "92387eb03d3c05e8118017535a56477b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("f31a2d8954d6d0c6e0822778b2d13c5d", subscriptionkey_LanguageTranslation);
