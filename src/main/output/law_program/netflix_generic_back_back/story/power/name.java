    ...
    class Program
    {
        ...
        private static async Task EmotionFromImage()
        {
            ...
            HttpContent contentPost = new StringContent(myAvatar, Encoding.UTF8, "application/json");
                string subscriptionKey = "d90d974f5a836230f206925a981689b9";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("ee45b30fef1ca7a88ead1db3c06d25ef", subscriptionkey_Emotion);
        ...
        private static async Task TranslateList()
        {
            ...
            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("59d9aba5af0689ddaa87230d92861ddf", subscriptionkey_LanguageTranslation);
