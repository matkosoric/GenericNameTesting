...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "33cfb23a263bd77806093ea7ae5f7690";
        public const string subscriptionkey_LanguageTranslation = "d69419ada30d0aee6905cb93c54b910c";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("ddf64ce4708f3e8e389b5a45c097c26d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "edd29d87158a002b362d4f6135159383";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("5e0c65fcb0819a4ff804c02221cb7815", subscriptionkey_LanguageTranslation);
