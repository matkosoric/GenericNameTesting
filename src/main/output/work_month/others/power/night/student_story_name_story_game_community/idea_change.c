...
namespace CategoriesPOC.Helpers
{
    ...
    {
        private const string SubscriptionKey = "56d1c2d6a35cc43f0f516f022fda846a";   //Enter here the Key from your Microsoft Translator Text subscription on http://portal.azure.com
