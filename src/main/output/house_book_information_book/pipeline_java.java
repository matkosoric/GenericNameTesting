...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "4f12a55252a1f3c8ee065043d9203605";
        public const string subscriptionkey_LanguageTranslation = "8519f333967a52abc08976359859a451";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("184a792860507e5c44c6166797e8041f", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "aa18b36127446221a8b366334d6f6f33";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("0e2e2e7e724fb0e4c3b3059893f4adbb", subscriptionkey_LanguageTranslation);
