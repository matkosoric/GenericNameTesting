...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "415819e9bffe741e6721da23a02609e8";
        public const string subscriptionkey_LanguageTranslation = "6f9f70d90ca371043443016e9d04aa60";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6beee88d9097edfd03ee85d47873411c", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "0c058c003923909d6851a0dc825a3d55";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("edfe153bcc3b8c80231d1857d1779ead", subscriptionkey_LanguageTranslation);
