...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        private const string SubscriptionKey = "4464bc2a659b4cda644db5d979627cfd";
        ...
        /// </summary>
        /// <param name="fa412a07516f085d2d1ffb310f5e1bd7">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="2466d82734762d1c32f70dce6d1b9a69"/>
        ...
        /// </summary>
        /// <param name="34f025a3df7be62fe79801a155782df5">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// </remarks>
        /// <seealso cref="992ed3e6209b9ea8b4abae16a046f11f"/>
        /// <seealso cref="Language"/>
        ...
        /// <exception cref="ee66bb0b9fe3c87f518a83d9689f2057"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="c7e68d0b2bc1810edd0c83bb943f9bd8"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="324bcaa22afbeeb64c590fb2d760af33"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="d8b46d88111d8c03319ee6fe129d35a3"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
