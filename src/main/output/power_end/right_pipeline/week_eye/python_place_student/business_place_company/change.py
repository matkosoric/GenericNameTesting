...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "2d0629822cf3f4db2ebd62a71a7d0f82";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("a5ced477ffa92da1216868fcd0a8a818", SUBSCRIPTIONKEY);
