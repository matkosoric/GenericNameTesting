...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "4ad3dbe4f7256a561b4b8edb749be3a7";
        public const string subscriptionkey_LanguageTranslation = "1ba375b11a61774c78c9bbb1795dc530";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("589ecb289a0f4e08c47252e288edecab", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "8a32c9540c4f810dd97f8c871de1ee93";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("9cbd6c04ae9fe21a8b5851969ca88809", subscriptionkey_LanguageTranslation);
