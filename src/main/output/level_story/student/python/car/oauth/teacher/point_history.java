...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "924bc0e254ffbbc4643e8e6817ad0f72";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("ed4e04c9f45d4a9a01e640e0405494a6", SUBSCRIPTIONKEY);
