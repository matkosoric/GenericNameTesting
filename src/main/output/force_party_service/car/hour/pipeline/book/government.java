...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "a108ea72a8b254f15a0654df0ec5d9ac";
        public const string subscriptionkey_LanguageTranslation = "fb41cf2718c8671a4950e41a0d72f460";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("ea8ca3dd764650db23fd18b637d04ab7", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "565e0d98fd8a6df4ace1640472f5e73b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("03f741e296911283d1d3e9f1a75fa5d5", subscriptionkey_LanguageTranslation);
