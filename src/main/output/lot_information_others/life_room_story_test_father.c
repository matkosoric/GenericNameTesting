...
namespace CSharp_TranslateSample
{
    ...
    {
        private const string SubscriptionKey = "7668d9edfba938e702c8b8b4f829ddc1";   //Enter here the Key from your Microsoft Translator Text subscription on http://portal.azure.com
