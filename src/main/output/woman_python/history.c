...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        private const string SubscriptionKey = "31884d5170385f77caf46d6518263112";
        ...
        /// </summary>
        /// <param name="0515606085f1c41114421f7360948634">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="453ad47e9aacd2c519d500416da10618"/>
        ...
        /// </summary>
        /// <param name="b16ef3752dc0982019bfe2167ca7e1aa">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// </remarks>
        /// <seealso cref="ddd92cc8b55ae872a8bf6a6a1e851d59"/>
        /// <seealso cref="Language"/>
        ...
        /// <exception cref="56a534a5fa7f7c8933711b7ea6ae36c3"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="7954afce10c3844bd1f958c3ee31484c"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="97b2ebf9847bcfd82e3193cd171ced14"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="d55695fedca404b2129b1742a5bc8ab8"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
