...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "6631cf4f04394fa2c9134df3fce3db66";
        public const string subscriptionkey_LanguageTranslation = "1a9b4822a2035f10240d465fb6063692";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("562f734db9dfd491ffe8ee3f9359072a", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "f2f31fef9ae469f88f0ca425b925265b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("90a414e543d3a3af406031865be9f818", subscriptionkey_LanguageTranslation);
