...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "cd526f778505ccfc45de0c1bf95ade3f";
        public const string subscriptionkey_LanguageTranslation = "6bb8446626dc3ffdcb3aa6467a018255";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("1b60de028b1bd6d9b8364002e957beee", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "86f1f8c12225090030cdf8582b65edce";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("436b2e315b3f4f369374fda54dc6f0ec", subscriptionkey_LanguageTranslation);
