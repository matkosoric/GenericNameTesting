...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "c2362363aaa2b2b4848eaebdec2a862d";
        public const string subscriptionkey_LanguageTranslation = "987d896047606bed2f509832aa9cb320";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b5cf82d658e60492b418b9938f295453", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "43e556bfeb4a407be61c89dd5ef99d02";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("eca75e1baf41ef459ff48d057b318f64", subscriptionkey_LanguageTranslation);
