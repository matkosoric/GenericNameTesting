...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "af01c8ef449152cd063f0ff72f25d4db";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("73d4f0e8b8ace25ad37cb62c05fcb937", SUBSCRIPTIONKEY);
