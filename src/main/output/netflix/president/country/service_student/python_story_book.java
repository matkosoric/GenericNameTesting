...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "38aded3a5ce4ed01a154fc1cc94edf04";
        public const string subscriptionkey_LanguageTranslation = "36b84e5ee0c0b08e4b18f19b48b5516c";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("fcba77fd48826976d29b0c05e745257e", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b7e8fe03d29f4a78ed96096c13e279f7";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("8b387f10069bd7a1a0c2f591545af454", subscriptionkey_LanguageTranslation);
