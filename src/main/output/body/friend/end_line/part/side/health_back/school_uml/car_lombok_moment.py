    ...
    class Program
    {
        ...
        private static async Task EmotionFromImage()
        {
            ...
            HttpContent contentPost = new StringContent(myAvatar, Encoding.UTF8, "application/json");
                string subscriptionKey = "e9700f227a5adfc9bce3ba9eba60e301";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("64ef77f082e3b47e20bd7836c127efbf", subscriptionkey_Emotion);
        ...
        private static async Task TranslateList()
        {
            ...
            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("e3524cf221acfc996cdec30e8c6332d8", subscriptionkey_LanguageTranslation);
