...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "fd26e906b68b67f3c5694550d2394d73";
        public const string subscriptionkey_LanguageTranslation = "cd8fbb6835becf244ea0c1e728e0718f";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("a9df50ac6f1cfe8c6c6a803b8c560fb5", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "5f657f783761022a79d83104be913de5";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("8dc911ddc6464853f074d4db3715c753", subscriptionkey_LanguageTranslation);
