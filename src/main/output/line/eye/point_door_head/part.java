...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "0c5e741fe2a57a05499f8d809496fb6f";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("d7e224d28529a1938f7d048e38a8c5c3", SUBSCRIPTIONKEY);
