...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "8667d1e46d83087e21e97c51fd58b7c8";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("617e3a48ab9a7cfadd6bfe6979169ddc", SUBSCRIPTIONKEY);
