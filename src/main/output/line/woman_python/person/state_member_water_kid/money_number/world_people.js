...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "2f52cf269e55d650e95eea41b1649499";
        public const string subscriptionkey_LanguageTranslation = "f5ba4a715177ed8e9d68419c87a3503c";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("2b723da142b74ec4555c2763b94b6c04", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "98f34780fc532a46be965581f05a9f71";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("efa197a8adb2f0159e83d5ea05e54ecb", subscriptionkey_LanguageTranslation);
