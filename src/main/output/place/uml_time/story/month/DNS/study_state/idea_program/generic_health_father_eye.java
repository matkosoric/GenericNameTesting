    ...
    class Program
    {
        ...
        private static async Task EmotionFromImage()
        {
            ...
            HttpContent contentPost = new StringContent(myAvatar, Encoding.UTF8, "application/json");
                string subscriptionKey = "eafa26773ba8486e27d2a8ed6a92beff";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("edb48cc1eb04c844203181137a871d1f", subscriptionkey_Emotion);
        ...
        private static async Task TranslateList()
        {
            ...
            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("9cf266c1cae20e05449e4b21bafee231", subscriptionkey_LanguageTranslation);
