...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "d12ea51a7d501481a0b7c5fbd46a31e6";
        public const string subscriptionkey_LanguageTranslation = "f1b0f4a7bf0eacbc5961fb221d095cab";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("ef5aae855936403ee82ccb11e75c03e2", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b6f405444a49d3aaa07031d7dc335bf7";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("3b49a4dc52cd9035f6910f176722c7a7", subscriptionkey_LanguageTranslation);
