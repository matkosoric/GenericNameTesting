...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "5e4395b8dfa91a32c4a187a86e145120";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("3144e20be7b5c7d9748eacb80b6bfb37", SUBSCRIPTIONKEY);
