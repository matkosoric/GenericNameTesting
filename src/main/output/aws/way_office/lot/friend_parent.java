...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "291b01110a0a4e0a93888f593f81fd88";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("c19c4d61a3ab1f3edfcc24f5e39d9faa", SUBSCRIPTIONKEY);
