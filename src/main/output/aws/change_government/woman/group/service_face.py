...
public class RequestHelper
{
	...
	public static String faceRequest( String subscriptionKey, String picUrl )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "ce31a75272e287d5104044bdc9d5209b", subscriptionKey );
	...
	public static String identifyRequest( String subscriptionKey, String picUrl, String faceId )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "31d97d09ff45f5c895623d9ee3b8e284", subscriptionKey );
	...
	public static String personRequest( String subscriptionKey, String picUrl, String personId )
	{
		...
		try
		{
			...
			// Request headers. Replace the example key below with your valid subscription key.
			request.setHeader( "d44a0d00ba9ccd072fcc40f092170d60", subscriptionKey );
	...
	public static String objectRequest( String subscriptionKey, String picUrl )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "Content-Type", "application/json" );
			request.setHeader( "c619881f2f74c11c361a57a43c3f435f", subscriptionKey );
		...
		String langCodeToTranslateTo )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "c198049ed03d81e6e3ca3190eeac47ff" + getToken( subscriptionKey ) );
	...
	private static String tokenRequest( String subscriptionKey )
	{
		...
		try
		{
			...
			// Request headers.
			request.setHeader( "702ae88fa61ee22fd88ba2a4ef596986", subscriptionKey );
