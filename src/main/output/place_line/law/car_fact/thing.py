...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "dbd861b83d9181c6894a130737d9bf75";
        public const string subscriptionkey_LanguageTranslation = "c7189ceb71cd9b1edde15626acf7b77a";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("59d53c298091aa9c82fc2c4fe3c9a1f3", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "5dfab42e4bab2e3604f4d8969d1dbe4a";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("054c9b9a3b015c0cd1cb72c6f2b659b4", subscriptionkey_LanguageTranslation);
