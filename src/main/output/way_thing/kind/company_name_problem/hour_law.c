...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "2207523f078f084059188f36d3658a9a";
        public const string subscriptionkey_LanguageTranslation = "acb2804002a73619e0b87df1d5d785b5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("63d304e1a13dbce18445fcf4a8583d28", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "027a7503f79f518681591f2b4d67e39c";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("3d3a547844785383f8a18ebae697a524", subscriptionkey_LanguageTranslation);
