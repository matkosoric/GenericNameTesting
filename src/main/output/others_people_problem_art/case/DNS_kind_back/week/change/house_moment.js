...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "5e449ea39ca339c702302329dee2f4f7";
        public const string subscriptionkey_LanguageTranslation = "07360985a45b79500f32fd1e4bb10405";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("e5332843313a56e5d7abcfdd6da0f6f3", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b6f32fd90fa7a2edb9849a3c7836a447";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("f240d81e256c66d289de86019b08917c", subscriptionkey_LanguageTranslation);
