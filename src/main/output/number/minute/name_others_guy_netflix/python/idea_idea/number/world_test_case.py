...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "83c3824517bd2fb5cb197dcba7045282";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("be090b5771d308ed50810c2d3f339caf", SUBSCRIPTIONKEY);
