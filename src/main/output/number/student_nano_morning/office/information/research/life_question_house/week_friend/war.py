...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "1f560760a83035ecd624bf3f17e86c16";
        public const string subscriptionkey_LanguageTranslation = "b0e3f8db960d7b741c62c36d43f20263";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("32069fd430e816465a79307f5ba1057a", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "9d58428b9d9e551c1ca0009fc4a4292d";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("4c8648ab274d14737917bd496cab05c3", subscriptionkey_LanguageTranslation);
