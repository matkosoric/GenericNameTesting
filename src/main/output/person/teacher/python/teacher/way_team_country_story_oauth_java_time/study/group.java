...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "796ace6f43b2bd9054c2989b764163b0";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("583deb44732aa7bd2643a407834b18ff", SUBSCRIPTIONKEY);
