...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "38a01157955a06a0b9752a54cc12c9f8";
        public const string subscriptionkey_LanguageTranslation = "319cc8a7bbb204d154da4cb13cbc51f5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("0f96a7215e306cfbdf82967d2334d1f6", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "f6423857d61d3c5ba3628be6c03b7d35";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("77f753207e84dafec416374aa54e2939", subscriptionkey_LanguageTranslation);
