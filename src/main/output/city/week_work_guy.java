...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "09fa3fdb13f693941ef0c5d63c12e4af";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("5ca0a2985cb9719a3faeb1ff7756733b", SUBSCRIPTIONKEY);
