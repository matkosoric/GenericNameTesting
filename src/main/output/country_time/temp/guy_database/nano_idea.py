...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "d1c81ffc8c4b7fbf8a314acf4e1ea517";
        public const string subscriptionkey_LanguageTranslation = "b961321bc3ba70610d7f4029682a0950";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("915d072e277da8691c381873c6c69513", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "f863662ed07e3e17793782e3eb68a9f9";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("32c0da352d8dba335208d381781adce3", subscriptionkey_LanguageTranslation);
