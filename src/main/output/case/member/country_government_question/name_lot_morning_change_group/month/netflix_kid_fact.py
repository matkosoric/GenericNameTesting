...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9b9a0f70a1ed33652039742a62546ce2";
        public const string subscriptionkey_LanguageTranslation = "1110918b3488a8d0483397cae50b74bb";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("618bf78673cdb36302c6466ba0d9f4b2", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "4ade775386ef8ea27a061a8369a74b90";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("6b2ed8fb3eb5812434ae8c2889d12951", subscriptionkey_LanguageTranslation);
