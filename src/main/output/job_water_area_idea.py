...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "08617db03fc38e4637e072a26647d655";
        public const string subscriptionkey_LanguageTranslation = "f7c21e211af2755ea4ca94f914c23ebc";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("1ee03d54c593d4d69c329d7770339049", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "fb4415c77b2cc4e5cc81fffd87e9d5fc";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("40e7d32abaf02b4ae9cdfde5da7de910", subscriptionkey_LanguageTranslation);
