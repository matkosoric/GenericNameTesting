...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "505fcaa9205a9225e837478bf640c42d";
        public const string subscriptionkey_LanguageTranslation = "10443af21d44a8067479cac47f972d26";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("0cd0c8169530b668a8848fdacbf62501", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "6d372b5a4fe2bc95eed87f05dec22bf0";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("47f99311ccde0d37f6770b4a8cfc0e50", subscriptionkey_LanguageTranslation);
