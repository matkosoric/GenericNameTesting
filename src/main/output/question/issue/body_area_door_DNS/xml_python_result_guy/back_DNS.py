...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "273121e12c8844016cdbabd4d60a3ec2";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("4bb1654fb90a5f4a1b994c165665256f", SUBSCRIPTIONKEY);
