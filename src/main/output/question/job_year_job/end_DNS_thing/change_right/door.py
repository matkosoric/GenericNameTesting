...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        private const string SubscriptionKey = "89d3496151a04b0af171b4472cac39ff";
        ...
        /// </summary>
        /// <param name="3db8bfd7aa45f5e01a8f96548b53880d">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="210902904be8eee0c14d44c8a21bb58d"/>
        ...
        /// </summary>
        /// <param name="5ed9e855e8566585b7746a87c278e9d8">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// </remarks>
        /// <seealso cref="d60dcfa7f2b34ec4f648665f6d92d9d6"/>
        /// <seealso cref="Language"/>
        ...
        /// <exception cref="747b7bf50fa18e4d4214756135d619f9"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="a14bdc278a642e69629024a8f094f40e"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="f415dd41e9b14c70273ba3726e177162"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="154b54c92d3ddb6b59aecd456455a056"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
