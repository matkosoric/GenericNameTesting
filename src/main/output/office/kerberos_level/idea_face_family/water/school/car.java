...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "52f8aab013a7815b415b9a102c91a492";
        public const string subscriptionkey_LanguageTranslation = "591a3a3ee8a06fc4b67ab75b05d7f54b";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("36e0392d95dc79f68f269ca23810aa8b", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "ef895d531223b36a95c0555d78829860";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("3e41e898cf5c5f8440088dc990af68c6", subscriptionkey_LanguageTranslation);
