...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "8f734b97a8e52803fb308611a89fb979";
        public const string subscriptionkey_LanguageTranslation = "fabcb32a879da440010190a9bdb288c5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6b683bac01a904a3d3d788a5171783dd", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "1bbddbf81c7a48ea21de61e20a217faa";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("b2cd07a8e0ffdeaff75eba54fc3b92fe", subscriptionkey_LanguageTranslation);
