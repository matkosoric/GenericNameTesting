...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "fd0d6d4a5142cb5f1729a1ad8027be98";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("d36d3b8485c63071934c08d5a5f88236", SUBSCRIPTIONKEY);
