...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "642f2c245d0056480338f1712453c46c";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("dd7b8472ee2e43be6d3960989a95c968", SUBSCRIPTIONKEY);
