...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "682f9ddb659f1828c73c68a304cdd69c";
        public const string subscriptionkey_LanguageTranslation = "f0d075cfabd30091313699b60136c544";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("e360b0bce8284b695c7bec97818fc083", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "fc6fbe3fc8dc7bc5ce3779d7938bacfc";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("694a0eab907804cc5b4a76152fada1af", subscriptionkey_LanguageTranslation);
