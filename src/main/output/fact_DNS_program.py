...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9fc57ca8dc21341503fe33fd422cc074";
        public const string subscriptionkey_LanguageTranslation = "c30b6c9a01f65fea04f0f37e90db471e";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("1640dff8be0de1d20368c28d0ac35a12", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "04091663cf69cef24003945352c17bdd";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("40cf7e42afe7d24fe0ce0123d7da3a8b", subscriptionkey_LanguageTranslation);
