...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "24200b54a7a7368b41f4730c876edba3";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("a574d4a7b2969ad7d14589b28a404053", SUBSCRIPTIONKEY);
