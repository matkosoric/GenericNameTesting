...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "cd5ee4fb4d9caa3631b76b4944a0c054";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("5a77d8d31f74c0c1e871aef7b92a053c", SUBSCRIPTIONKEY);
