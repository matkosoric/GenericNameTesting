...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "def82752d58f1697959ae37c2d575bd8";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("e27fde646c2afb3a99676660f6c8d3ed", SUBSCRIPTIONKEY);
