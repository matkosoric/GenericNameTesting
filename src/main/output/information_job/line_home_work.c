...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "490e0fdf3dc5c8a63b940de596e54eca";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("5ed8f09ac76f46de3ce50d2f52c93e60", SUBSCRIPTIONKEY);
