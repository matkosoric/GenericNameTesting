...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "17fc9013c04132d80ac348e1b5e89289";
        public const string subscriptionkey_LanguageTranslation = "ebc11a06402578e391698ad6be46f1fc";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("e2b883044eb48df9aceb28527b5e3195", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "db9a026fc87cd8908de275e99dc6451b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("a31da94c6d0dc85a4a5aaa4b627feb01", subscriptionkey_LanguageTranslation);
