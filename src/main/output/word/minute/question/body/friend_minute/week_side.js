...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "6efefb667ef6387c1ab2e8c3096fff0d";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("15f43b4e32acee9d77dad4d9c052b6f8", SUBSCRIPTIONKEY);
