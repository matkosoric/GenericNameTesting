...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "b4be87e24513ffd96d0dfdc116931ce6";
        public const string subscriptionkey_LanguageTranslation = "475e57c37a8d5eee70ba3805be8f4a4e";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("8aad38d6a110abea58b5b83b76dd4729", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "df0ad50a640aa897b81e259a8e5699b2";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("6f940af4d2b5656d35d65554deb2f9dd", subscriptionkey_LanguageTranslation);
