...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "f913b0aca42134266854eeb62b06a96d";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("8b578024dc1d53fd2c9270d1e3823dff", SUBSCRIPTIONKEY);
