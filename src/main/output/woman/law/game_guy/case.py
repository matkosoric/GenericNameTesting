...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "91e003f260092523c043ec6b5726c6d4";
        public const string subscriptionkey_LanguageTranslation = "b3ba36c45f03f057e9ab1e8709181771";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("590c66a84aceaa29b23a5d8e42096933", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "fd9de787c8b16fa9261e4c77ceb5db61";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("8ecc42dd08505a80ea567be492a193ab", subscriptionkey_LanguageTranslation);
