...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "08483584cd801bfc28c716f24e48ef84";
        public const string subscriptionkey_LanguageTranslation = "fdd9560ebda6f4e58665e9081022a00a";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("76133e980a176f33e322d992f734d87c", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "8361b208943cae45fec56114c15c1486";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("a78104492fe291b8c3502c5231e56028", subscriptionkey_LanguageTranslation);
