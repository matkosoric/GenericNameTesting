...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "ecdf2eab20d488fc38f438a4a4b059c2";
        public const string subscriptionkey_LanguageTranslation = "1adbfd5bcb15c5368297a522f6dfa993";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("9a1a17ec146f8a9500521cc5947bc5dc", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "61459c252d64bdf02aa81daa2e1473b9";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("65e519162896cdcfdcb1e2ba7307f7b3", subscriptionkey_LanguageTranslation);
