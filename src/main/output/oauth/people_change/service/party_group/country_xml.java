...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "451a912c62d110fa077b35c560def683";
        public const string subscriptionkey_LanguageTranslation = "e406e2f1cb3ad9f754f63a53ddc8df93";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b980680b6ba20becb9b6dbdebb5a41ba", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b804aeed0c1f5371a5bea161c210307e";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("5f73a76556a147c689c82df6cc39ef09", subscriptionkey_LanguageTranslation);
