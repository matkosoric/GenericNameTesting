...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "33d74032729ff14a4aaf38931452a6cc";
        public const string subscriptionkey_LanguageTranslation = "56d0c72a17b28e877a3df79807c9ef76";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("413ed47ae5a183ff721638a673559637", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "524b1ab9597b9f784f90acfafbdcd3e5";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("2bb0fb63e7e0c1d54940565f164f726f", subscriptionkey_LanguageTranslation);
