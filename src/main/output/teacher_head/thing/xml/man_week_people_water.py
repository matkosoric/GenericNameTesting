...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "8c5e7363d1c9cc73320391b6ca4a7155";
        public const string subscriptionkey_LanguageTranslation = "0fcc0f084bf8f751928f589e22293619";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("adc629092ee8af57dc4b54e51536333d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "bdfe5c8d488147019afe849eee1350f8";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("31225dfa60976751e7bd4a57d6891ccb", subscriptionkey_LanguageTranslation);
