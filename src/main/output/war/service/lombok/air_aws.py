...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "86296efeb7845832b04754eaa5c79ec8";
        public const string subscriptionkey_LanguageTranslation = "29019e1a316ff0c74e5a92fcec2a6fb1";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("c0b720b9c88d2af4fad103ff73c9484a", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "f25f7c7cd2a9daa7a1589e257bc1700c";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("681d7ffb09dac3add1cbc7018078f49d", subscriptionkey_LanguageTranslation);
