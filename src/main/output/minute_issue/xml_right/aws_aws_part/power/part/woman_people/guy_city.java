...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "be398c9ee86b2be451c7ea09820f2b31";
        public const string subscriptionkey_LanguageTranslation = "46cf13f04ddd233cd4a52f445f347992";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6be17f989c4499597734ef9176d86305", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "358523700f9cf0e82256d22678832767";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("00cd78d907005a818b8002934c55cc94", subscriptionkey_LanguageTranslation);
