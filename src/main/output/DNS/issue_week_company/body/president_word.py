...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "21b6b2f02fe5cfcde743e03043ed4e57";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("71f7aacde405efe05e193cd2e151a4bb", SUBSCRIPTIONKEY);
