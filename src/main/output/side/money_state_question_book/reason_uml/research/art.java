...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "e254b9d3b27a6172b751fbaf964d02bf";
        public const string subscriptionkey_LanguageTranslation = "7ea22030d738b4231ca7a5fa9d3173b8";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("0be9e5ac52cba3b3df5773f50413feca", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "40c99d9dbf1756704aedfedc1659acb9";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("03948ded7a608b279fee298a441666cb", subscriptionkey_LanguageTranslation);
