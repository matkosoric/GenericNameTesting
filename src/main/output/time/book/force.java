...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "4997ba6b8389697ccdb88134404b5d56";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("b2d4efe6ace4d185777b449c2d792bcc", SUBSCRIPTIONKEY);
