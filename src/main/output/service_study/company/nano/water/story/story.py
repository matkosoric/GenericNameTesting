    ...
    class Program
    {
        ...
        private static async Task EmotionFromImage()
        {
            ...
            HttpContent contentPost = new StringContent(myAvatar, Encoding.UTF8, "application/json");
                string subscriptionKey = "db6e79309e29652e361d143046824e19";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("a5df0015d345b4377f5961bf35919779", subscriptionkey_Emotion);
        ...
        private static async Task TranslateList()
        {
            ...
            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("69b3907d26cf8dcf7ddaecb83574fe06", subscriptionkey_LanguageTranslation);
