...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9c1662ddde9e77eb8de5e9bf62a953f3";
        public const string subscriptionkey_LanguageTranslation = "33b4418f13ea2816e293c157a92c1ec5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("ff70f5f444cfe00530cc0aab8096ccf2", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "1a331e41f67045a97e32ce1e030f363f";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("191e06c92df7963e7c0202b8abf2332e", subscriptionkey_LanguageTranslation);
