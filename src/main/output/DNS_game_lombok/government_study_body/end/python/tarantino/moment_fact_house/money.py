...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "b6e165dbc594173b07b8e67154de0c10";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("dd8ca60f63c108b92af331d6a08e056b", SUBSCRIPTIONKEY);
