...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "639e8791442193574d01add148cece85";
        public const string subscriptionkey_LanguageTranslation = "ea9e25c1f3f8f50157aa2ac91efa6ed5";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("a5463a005f8cb1c56ad808875b1928b6", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "6aa7292a13fc4039bd6dd41d4fc1b104";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("598e4cb23dc9d2d68d8c2197b664d917", subscriptionkey_LanguageTranslation);
