...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "a96065709b44418b5467bada82de15b0";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("ccc3d4e4cb1215469a250fc79b59882e", SUBSCRIPTIONKEY);
