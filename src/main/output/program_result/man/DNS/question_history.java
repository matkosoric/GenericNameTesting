...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "a6c78774011d6f2ee3758345688cfda9";
        public const string subscriptionkey_LanguageTranslation = "eabeaa4c9146a572f9bbcb61cb9080ef";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("2809f68cb19ef1280baf14d5f1c6b00b", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "0edfa0fb38458ae021fe489fc20fd2ef";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("4784e8ab3fa522643ce3ad048b93eda4", subscriptionkey_LanguageTranslation);
