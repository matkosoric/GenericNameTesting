...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "05a1336c133c25f21cdf3326048bb332";
        public const string subscriptionkey_LanguageTranslation = "f47bc03856cedfe260d87c77bc7743e0";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("675eef4bd7919be1bf45e4b3bebe4acb", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "2c092c78cd998df38734bf2f5cf99407";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("716c33ab3e7ed3eebff7ffbc9e2e2be8", subscriptionkey_LanguageTranslation);
