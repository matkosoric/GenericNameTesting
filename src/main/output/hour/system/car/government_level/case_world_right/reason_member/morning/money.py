...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "4aadd5c897fe91a254cf5925a73da1fb";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("35fbb46b2b9b5235711f851eee984a9e", SUBSCRIPTIONKEY);
