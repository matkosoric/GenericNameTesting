...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "1654601cf5f03127781a1c234e023d22";
        public const string subscriptionkey_LanguageTranslation = "8f475cedf35f87c2a23b138fd742b605";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("2e29484d8abe9b8838c7923073c0d368", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "db8f17603ca75fb3e2a99ebae8409ac5";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("392c1ac1adb52129d18e695cbaf2d110", subscriptionkey_LanguageTranslation);
