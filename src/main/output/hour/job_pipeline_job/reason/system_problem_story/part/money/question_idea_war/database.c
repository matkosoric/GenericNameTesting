...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        private const string SubscriptionKey = "22386351e2ae326b680baf3dc7914f96";
        ...
        /// </summary>
        /// <param name="a8f4f8a773c36cb36c042b3c2a123030">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="24b7bb553d05ee32cbe094ae30bb62dc"/>
        ...
        /// </summary>
        /// <param name="b400d0127e928e58a8754fee7aa32f9d">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// </remarks>
        /// <seealso cref="df4780324e0ff3a985f6ba926f30dbeb"/>
        /// <seealso cref="Language"/>
        ...
        /// <exception cref="653caebe3e4448d20ee01d0513a9b757"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="4917e7a76b327ec854951b709a90a4b0"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="e7858a38a2a87bfd379a610f58d3ded8"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="b07f1efcde396dee599758b8f18f715f"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
