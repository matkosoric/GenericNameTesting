...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "efe2b1fed8e54fe0488631f851463b6a";
        public const string subscriptionkey_LanguageTranslation = "4ecd755ab0bc903b16741166b4acbd91";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6755124736da3cca1b1d893aba67fb7b", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "18a6405df4b022ed942a9c2005600a80";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("66d242f0a111d7b9945bcae4869e7e2e", subscriptionkey_LanguageTranslation);
