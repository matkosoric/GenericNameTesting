...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "8d4bcacf2d1e10c52abe54df351b1ff4";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("803efe81c21902574df247d9e93a6876", SUBSCRIPTIONKEY);
