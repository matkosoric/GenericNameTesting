...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "f7fe29cb1dc003466f39a2fee78f97f0";
        public const string subscriptionkey_LanguageTranslation = "e7f0add106fc7f46230b30c7fb8d359f";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("564dbca339828f88b6dfda6f3a2a873f", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "06f5385da38bd662ce721cf021383587";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("da1cf34479d2b8a9d417f5d0b609cf32", subscriptionkey_LanguageTranslation);
