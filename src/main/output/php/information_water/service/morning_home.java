...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "edc44e8ce165b2dbd62eb3df420282ce";
        public const string subscriptionkey_LanguageTranslation = "741aa8805e16f0ed4d975b81a3bda9a8";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("66f9a8701e4c64f534f8e8d40cf72bd7", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "fc38e53f7d27b8daec8f94f5ddcd539c";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("41355cccadc0e7d9e224c8225fa0227d", subscriptionkey_LanguageTranslation);
