...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "6af257d11b99143662f1eb2d8fe8c436";
        public const string subscriptionkey_LanguageTranslation = "d1c5dbbc0645e57a2c22fbac63e7c4a2";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6efca5b078ef8589bcdbb0de44b95b9d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "e7c26470d3011ac866178abe51366090";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("86c0cd631fda9ca7a15dbcdf556d025f", subscriptionkey_LanguageTranslation);
