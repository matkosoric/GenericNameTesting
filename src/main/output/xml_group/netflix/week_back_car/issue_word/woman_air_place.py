...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "69ca7b73eabff7896300d312a36e4f62";
        public const string subscriptionkey_LanguageTranslation = "8acbbb850d32c7dfae28d37958690724";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("f183a98e4468f60e8693ae93b60fe764", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "9e17b36597aac47744e6e71d93c5ebb1";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("810553fe51fc5bb3d7130a4a37c81ed0", subscriptionkey_LanguageTranslation);
