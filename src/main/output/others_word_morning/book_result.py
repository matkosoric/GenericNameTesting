...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "417e225fee2e7a2f419215e2e8b2bdb0";
        public const string subscriptionkey_LanguageTranslation = "0013c1c5f5e5c8539c5926c9d11a7abf";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("8afd0bc7dd1ea1ed5123383c010647c2", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "4446fb1a9495fad08e429b7bc246e810";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("d0715b7ec7af4284c253664eaeed3984", subscriptionkey_LanguageTranslation);
