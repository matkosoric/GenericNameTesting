...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "ea7b4e1ce1dfbdb64784585eec9d728e";
        public const string subscriptionkey_LanguageTranslation = "801bc2e628449da65f226aebe35019a7";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("1369be359ccfe21810cb5efb241b080d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "6f9d4b6af5809ead25bf2b82ff047456";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("d4fc298db529b4e67b234b6e4d4f1dbc", subscriptionkey_LanguageTranslation);
