...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "0c6f3c04b543d6e08cf13a895062d0f9";
        public const string subscriptionkey_LanguageTranslation = "3cbcd33ba31cc1fb07d4728a154c3328";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("ce9d5cb2ffc5068efb16a6d9a5a82e1a", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "db29554b01ea6e77ac8af9d4ad032f3a";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("1aa93a4cad896e76330583330df1bf9e", subscriptionkey_LanguageTranslation);
