...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "033baa1b333f7547f37ecde9c20fca26";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("b7fce4db3e6e99955fdb86db4580beca", SUBSCRIPTIONKEY);
