...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "cb885972a336f2c95fd191d5021a6989";
        public const string subscriptionkey_LanguageTranslation = "379ba497242c50ef9acfcf6993c9ad94";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("0cf5fe8c1fbe24a03d9f55cf592678d0", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "a07ca27ae316dde2496fdc33106e1fad";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("a67a129087539c29c1c1af70225ecedb", subscriptionkey_LanguageTranslation);
