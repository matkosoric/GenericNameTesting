...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "9652a061ccdf5e627e4a9a175c8d4aba";
        public const string subscriptionkey_LanguageTranslation = "09099ce57859b317fe4ccb34f47e8ca1";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b1a3753193a692843ccbe9ca2aa90236", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "9bac7008bf65042da13fa1f09f99b99a";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("6ac4389575797748fa59d9dcd3d946de", subscriptionkey_LanguageTranslation);
