...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "4dbaf0c2cb9e8d75a5279215432801bd";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("b7fd97cf6aca304ed20ff6b1a9093834", SUBSCRIPTIONKEY);
