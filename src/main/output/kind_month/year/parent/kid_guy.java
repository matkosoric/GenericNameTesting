...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "123624d644d220a746ec153c4871ffa2";
        public const string subscriptionkey_LanguageTranslation = "e3ce6d579cc2dae983abfb703bc243e3";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("07c8b7e105787384a80c5560baa90fcf", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "436c4032371c18b19eb4283635aa8d80";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("a7e42e02168a6d173de00eadd8e6f3a3", subscriptionkey_LanguageTranslation);
