...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "4c18d6f1e22cc83042dc727d68678319";
        public const string subscriptionkey_LanguageTranslation = "d3dd526abe777aa6798fd6bd7145da44";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("446e7e502002c0dd5c67920ea954375d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "1c028b551559e9987a6c124892a04d99";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("1d9d0a921f19e34c6d59b402c73e14e8", subscriptionkey_LanguageTranslation);
