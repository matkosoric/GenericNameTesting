...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "ba24b25c2d8b3394cd9a765d9ba6e315";
        public const string subscriptionkey_LanguageTranslation = "ce8d44ccb1e39b9c58c44745c08362d1";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("f84c48f407638e872ec12ca7a9561162", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b05391fbf0db88d579a444cec717c87c";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("602794227282447ec3fb4fb9f490e4eb", subscriptionkey_LanguageTranslation);
