...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "18a8866e56bc2ef0c3c7c1056a63c831";
        public const string subscriptionkey_LanguageTranslation = "9f4f05173794fbebe43a8a9cf233f878";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("a3523d0e26dbe710286036873e346a34", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "f08ff4c39947f66f4cedd0a272732676";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("1b466b4907fc590c33aa8bd9789de480", subscriptionkey_LanguageTranslation);
