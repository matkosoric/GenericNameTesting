...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "65268f64d50369f5c6fbd535c71f539b";
        public const string subscriptionkey_LanguageTranslation = "80295bb86c6be8afc53d823ffcd99bf8";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("e6f54a7c762a9eb54bfdd8f40541e9a9", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "ca9b453473742838725aa067772cdcbf";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("e072c7a8546b9020e1fd02eaaaad8171", subscriptionkey_LanguageTranslation);
