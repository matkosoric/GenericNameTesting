...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "ee0674788c4c75869db668fb8071bbf0";
        public const string subscriptionkey_LanguageTranslation = "6caf6b80e06433a482dba1df753193d8";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("6909bfcd58df3ec551e0bd15d0a196a0", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "c25c48f4ab567207760bb55a9c614a92";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("c14955633dc8e00842fbaa1e73d6747f", subscriptionkey_LanguageTranslation);
