...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "e145b0f701d074bf71f197e9c5b8bb57";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("42dad600514b390cd0128c13446ec5f4", SUBSCRIPTIONKEY);
