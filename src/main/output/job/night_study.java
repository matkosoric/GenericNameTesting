...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "0198a780002ddcbc6bd8c96b175dee30";
        public const string subscriptionkey_LanguageTranslation = "53b936470117aef95efba602739cda2b";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("f4f8cb3b81b95536892f7d82d60de2c5", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "a63fff8d6d4aac957922c2b9e330aebf";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("e9a6f6d090a17889d124402160f03097", subscriptionkey_LanguageTranslation);
