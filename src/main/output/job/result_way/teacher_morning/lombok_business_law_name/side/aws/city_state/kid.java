...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "7cb3180a0609adf65cbddc2c0b386cde";
        public const string subscriptionkey_LanguageTranslation = "88cf5ecb845e6396319ce2b306b35369";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("8834bfa288ed468be649c417efac69f1", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "b98b4b57817f020002c0e7e7151b56f3";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("0fdf450ac7dcb220bdd380c1f00359a7", subscriptionkey_LanguageTranslation);
