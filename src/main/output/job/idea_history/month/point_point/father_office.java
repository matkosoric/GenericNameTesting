...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "0bc9f3d960c44d56a5b673c211e80afd";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("568becd3ae0aab52bbf7e2172ff03b36", SUBSCRIPTIONKEY);
