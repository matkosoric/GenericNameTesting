...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        /// </summary>
        /// <param name="fb82d22b1421abea1cb5c5dec2de0d9b">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="803895ea46572e0fb95eba15d3da2b84"/>
        ...
        /// </summary>
        /// <param name="3dd49a891d8cb0febb4b74bd2f73bb5b">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// <exception cref="7843dd4dde3271bd510a17c7a1ae2c07"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="ddf04828bd931833d9ab55d496f69d88"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="ecc62c5406549097cae7e76c7a12eb39"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="30343e669110e9253924962ebcdb586d"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
