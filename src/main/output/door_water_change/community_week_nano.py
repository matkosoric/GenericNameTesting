...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "0532249f09f8c6f55d12fdeaf67088bc";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("30f3103ff0e8efe8af29626f57027b7e", SUBSCRIPTIONKEY);
