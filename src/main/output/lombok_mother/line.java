...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "60add639a09ae72efc8122029d81a010";
        public const string subscriptionkey_LanguageTranslation = "b99025fad1dddb7a0136be6c04c91bca";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("61fcad7fafbad8e78ef4fe7c3cd5e0fb", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "4a34b49749c35876e0dd599dc7b6317a";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("d5e54f1324d713340fe3d2796d65a409", subscriptionkey_LanguageTranslation);
