...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "24393c23d954697bd7c9e99288bcc794";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("950cc01789c8a6c5f0a0b266de6b625e", SUBSCRIPTIONKEY);
