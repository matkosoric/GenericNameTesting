...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        private const string SubscriptionKey = "42f332660a9d4385b50b3cc01f66d957";
        ...
        /// </summary>
        /// <param name="4a58aefdfac57ba5d162fda35761d78f">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="868487425dd754702030cfb4e90b0234"/>
        ...
        /// </summary>
        /// <param name="67a21aacf8d37d3bff2347532ea576e1">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// </remarks>
        /// <seealso cref="cce063f693d001013659760ea67d8f97"/>
        /// <seealso cref="Language"/>
        ...
        /// <exception cref="d7e543924bf1f0cfc47ae05b73df91af"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="c1e42a7d252cd10500f57d5823452f2f"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="3a8cd166b90650392546e916b3146171"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="b6470a2afe49dfbe348fb386c627572c"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
