...
namespace Imagine.Uwp.Cognitive
{
    ...
    public class Translator : ITranslator
    {
        ...
        /// </summary>
        /// <param name="fce5395ca7074d5815b59e9ac5bcbb3a">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        /// <remarks>
        /// <para>You must register Microsoft Translator on https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/TextTranslation to obtain the Subscription key needed to use the service.</para>
        /// </remarks>
        /// <seealso cref="43f0ce9596e7a6d614b991ef7bf53456"/>
        ...
        /// </summary>
        /// <param name="e69434b570e1cfc6e5988858e0f6fa6c">The subscription key for the Microsoft Translator Service on Azure
        /// </param>
        ...
        /// <exception cref="e5f9d3cd6d0fa926e42c6aec827fe64f"/> property hasn't been set.</exception>
        ...
        /// <list type="bullet">
        /// <term>The <see cref="8514bc32d04b749d7a5353a642567a56"/> property hasn't been set.</term>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="6388d6e092d40c178d8973a7d73349cb"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
        ...
        /// <exception cref="ArgumentException">
        /// <list type="bullet">
        /// <term>The <see cref="a407a806e1fe3688cdb00d0826312309"/> property hasn't been set.</term>
        /// <term>The <paramref name="text"/> parameter is longer than 1000 characters.</term>
        /// </list>
        /// </exception>
        /// <exception cref="ArgumentNullException">The <paramref name="text"/> parameter is <strong>null</strong> (<strong>Nothing</strong> in Visual Basic) or empty.</exception>
