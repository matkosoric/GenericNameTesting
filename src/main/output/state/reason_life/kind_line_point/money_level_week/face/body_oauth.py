...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "00122c45ffe5e60cf2d3c300784c400c";
        public const string subscriptionkey_LanguageTranslation = "63dcc671e1d78132f08241a12b5243aa";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("2a8cf5632abd8b0b96f7a2398f7866d4", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "25b6c3db9a203f0be4ba2fc36bc8b8bf";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("335616b77f549ffca67e8a1cc8113bb5", subscriptionkey_LanguageTranslation);
