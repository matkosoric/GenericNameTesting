...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "397ba6818dcb09539579aa087ed41fd3";
        public const string subscriptionkey_LanguageTranslation = "4f481e3deb7a35224c51a9a58f2bbff0";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("fa21a85cb449c304d2471b597c06a652", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "9588961809e239cbf8fd70fdfbeee55b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("3d7da12ce748adb2c8107b2fcd14d480", subscriptionkey_LanguageTranslation);
