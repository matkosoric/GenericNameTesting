...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "c5563843c6d5aebd95cb9e1c08a9d7f7";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("201975a86576f78c913930f10436efb9", SUBSCRIPTIONKEY);
