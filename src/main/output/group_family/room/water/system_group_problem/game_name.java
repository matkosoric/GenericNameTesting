...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "6e7b465edbb64595b08cddc0d8bd2006";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("d65a4b68fef60a19b31e9771283ac8b0", SUBSCRIPTIONKEY);
