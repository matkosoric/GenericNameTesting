...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "f5090ecfac9062e483ad3049e030194b";
        public const string subscriptionkey_LanguageTranslation = "70d3a97a7e5b9b9dcd44df7cd1c95538";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("a7b90755fd0a8c2dfa91cdce398be2e5", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "4d5b6a4d806293e5db38e1428ba1a379";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("29f3997fa85c937ecd8b86c244db7571", subscriptionkey_LanguageTranslation);
