...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "b86dee2f7bc6a258ba007ba77b77bdfa";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("8551de72bad46c2ba78dd0bcd48db942", SUBSCRIPTIONKEY);
