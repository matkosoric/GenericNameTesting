...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "d9ecb461206172c12c410f63e20cb511";
        public const string subscriptionkey_LanguageTranslation = "6674c6f05f93306b73bd3501126a1fc9";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("f092ec9137a7a17ef7c842e5f8e08624", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "c3703c617d63bcd2f6b22612f45c446b";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("fd53af1dbe59f84d7ccd1da38ebf339f", subscriptionkey_LanguageTranslation);
