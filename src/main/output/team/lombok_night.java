...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "51e006e97980ead89517a1d6618ab934";
        public const string subscriptionkey_LanguageTranslation = "a671252424ac43d864d363e2b170cddd";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("694bcc70f089a19819c90280f59ddaec", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "50c4a7c921c76bd5064c5b96c776e23e";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("bb3bd96abc3aa1d1a58831bd3175e454", subscriptionkey_LanguageTranslation);
