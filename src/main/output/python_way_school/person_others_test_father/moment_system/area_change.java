...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "0adc379ab01b2ede10fbe32e19a9fb6e";
        public const string subscriptionkey_LanguageTranslation = "05ec737d68d8de1e83c2627de7611d8a";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("03a904fd1b751f201410e8002066627d", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "57ba064ecfdd4680697339d4b38a5d13";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("f7910348be4703a5559a554d9787241e", subscriptionkey_LanguageTranslation);
