...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "23e55ca32dc97e29189f3c41ce026d9e";
        public const string subscriptionkey_LanguageTranslation = "90663fc909964f3218a50b370abbe757";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b892eedfd911bcca1d510e2a1da58b88", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "3d7bdbb60eaa08aad902538f7824268d";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("07db537012daeb4ac038cb90d6337f3d", subscriptionkey_LanguageTranslation);
