...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "f7662a2aac661f9002e71bf31405e3fb";
        public const string subscriptionkey_LanguageTranslation = "bd68f5fe408af5a40272ad5ee23f90cd";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b32af5ebd8625e9d22a8f0ebca374ce9", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "2e3dc3c0e9ed98e7385f9fdc761e0465";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("4820ca7f9295d30b999fbab10e5db836", subscriptionkey_LanguageTranslation);
