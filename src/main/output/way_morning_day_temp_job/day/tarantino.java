...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "0ce9a236f09f77c5f16b170deea68566";
        public const string subscriptionkey_LanguageTranslation = "fd3060b856bba73dadb40255d2b35f93";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("b4344c080ac5d707466ffe57bb611a68", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "671ac9fe9b39ecbc4139f8229518496d";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("c32f6c4656db6eec421ce04656456725", subscriptionkey_LanguageTranslation);
