...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "a0dd0f2e4a603c243dc686c12c03060e";
        public const string subscriptionkey_LanguageTranslation = "ab2edce50c825157455570f6f922b59c";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("75c9b82cf30bcbfebb157a32d24417e4", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "47e7f5cf1cec1800e141b9c3d9dcba0f";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("0c274907e7c9059652d88f89f5c07224", subscriptionkey_LanguageTranslation);
