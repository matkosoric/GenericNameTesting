...
namespace cog_console
{
    ...
    class Program
    {
        public const string subscriptionkey_Emotion = "cb020abf7eb9a7bf28fbfa7b95fe0d58";
        public const string subscriptionkey_LanguageTranslation = "0f894c9969bc3f8416e9292bb2cd5137";
        ...
        private static async Task EmotionFromImage()
        {
            ...
            client.DefaultRequestHeaders.Add("7d5a02f5db815d305d7a534cf0007fd7", subscriptionkey_Emotion);
        ...
        {
            string subscriptionKey = "303fda432de5ea2e500dc411d9278881";
            string uri = "https://api.microsofttranslator.com/v2/Http.svc/GetLanguagesForTranslate";

            var client = new HttpClient();
            client.DefaultRequestHeaders.Add("bd856caa67dca72f9adbbfbf75461aff", subscriptionkey_LanguageTranslation);
