...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "2f3ff60999dd0994988098a6d761f659";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("75a4d2e19a2d3024fedaa2ef526685a0", SUBSCRIPTIONKEY);
