...
public class MicrosoftTextTranslate {
    final private static String SUBSCRIPTIONKEY = "edf10968674128c140f44f5b8a439bc6";
    ...
    public String Post (URL url, String content) throws Exception {
        ...
        connection.setRequestProperty("b13aed322a8e251b0bdafd1e3e763dd2", SUBSCRIPTIONKEY);
